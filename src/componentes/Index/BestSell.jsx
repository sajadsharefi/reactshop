...
const courses = [
    {
      name: 'تیشرت زنانه',
      imageUrl: "/image/best/fmale.jpg",
    },
    {
      name: 'تیشرت مردانه',
      imageUrl: "/image/best/male.jpg",
    },
    {
      name: 'قاب موبایل آیفون',
      imageUrl: "/image/best/mobile.jpg",
    },
    {
      name: 'کلاه مردانه',
      imageUrl: "/image/best/Hat.jpg",
    },
    {
      name: 'ماک قابل طراحی',
      imageUrl: "/image/best/blue.jpg",
    },
    {
      name: 'باکس غذا',
      imageUrl: "/image/best/bag.jpg",
    },
    {
      name: 'ماک سرامیکی',
      imageUrl: "/image/best/mak.jpg",
    },
    {
      name: 'دفتر سیمی',
      imageUrl: "/image/best/book.jpg",
    },
];
  ...
  return (
    <div className='flex flex-col gap-1 max-w-screen-xl box-border'>
      ...
      <div className='flex flex-row-reverse place-items-center mb-3 mt-2'>
        ...
        <span className='max-md:w-3/4 text-right' >پرفروش ترین ها</span>
      ...
      <div className="grid grid-cols-4 gap-5 text-right max-md:grid-cols-2">
